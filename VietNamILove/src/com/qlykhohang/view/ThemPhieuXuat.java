...
public class ThemPhieuXuat extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        createButton.setText("Tạo phiếu xuất");
    ...
    private void createButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_createButtonActionPerformed
        ...
        if (dateTextField.getText().equals("") == true) {
            JOptionPane.showMessageDialog(ThemPhieuXuat.this, "Vui lòng nhập ngày xuất hàng!", "Lỗi", JOptionPane.ERROR_MESSAGE);
        } else if (reasonTextField.getText().equals("") == true) {
            JOptionPane.showMessageDialog(ThemPhieuXuat.this, "Vui lòng nhập lý do xuất hàng!", "Lỗi", JOptionPane.ERROR_MESSAGE);
        } else if (addressTextField.getText().equals("") == true) {
            JOptionPane.showMessageDialog(ThemPhieuXuat.this, "Vui lòng nhập địa chỉ!", "Lỗi", JOptionPane.ERROR_MESSAGE);
        } else {
            ex = new PhieuXuat();
            ...
            try {
                ...
                JOptionPane.showMessageDialog(ThemPhieuXuat.this, "Định dạng ngày không hợp lệ!", "Lỗi", JOptionPane.ERROR_MESSAGE);
                dateTextField.setText(getDateOfToday());
            }
            ex.setMaKH(kh);
            ex.setMaNV(nv);
            ...
            ex.setNgayXuat(date);
            try {
                exSer.addPhieuXuat(ex);
                JOptionPane.showMessageDialog(ThemPhieuXuat.this, "Thành công!", "Thông báo", JOptionPane.INFORMATION_MESSAGE);
                createButton.setEnabled(false);
                addButton.setEnabled(true);
                deleteButton.setEnabled(true);
                ma = getTheLastMaPX(exSer.getAllPhieuXuat());
            } catch (Exception e) {
                JOptionPane.showMessageDialog(ThemPhieuXuat.this, "Thất bại!", "Thông báo", JOptionPane.INFORMATION_MESSAGE);
            }
        }
    ...
    private void deleteButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteButtonActionPerformed
        ...
        int row = proTable.getSelectedRow();
        if (row == -1) {
            JOptionPane.showMessageDialog(ThemPhieuXuat.this, "Vui lòng chọn sản phẩm", "Lỗi", JOptionPane.INFORMATION_MESSAGE);
        } else {
