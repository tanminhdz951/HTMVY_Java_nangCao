...
public class QuanLyPhieuNhap extends javax.swing.JFrame {
    ...
    private void setTableData(List<PhieuNhap> ims) {
        NhanVienService emSer = new NhanVienService();
        List<NhanVien> ems = emSer.getAllNhanVien();
        String nv1, nv2;
        for (PhieuNhap i : ims) {
            nv1 = maNVtoTenNV(ems, i.getMaNV1());
            nv2 = maNVtoTenNV(ems, i.getMaNV2());
            dfTableModel.addRow(new Object[] {i.getMaPN(), i.getNgayNhap(), nv1, nv2});
        }
    }
...
//    }
    ...
    public QuanLyPhieuNhap() {
        ...
        imTable.setModel(dfTableModel);
        dfTableModel.addColumn("Mã phiếu nhập");
        dfTableModel.addColumn("Ngày nhập");
        dfTableModel.addColumn("Nhân viên 1");
        dfTableModel.addColumn("Nhân viên 2");
        ims = new ArrayList<>();
        ims = imSer.getAllPhieuNhap();
        if (ims != null) {
            setTableData(ims);
        }        
    }
    ...
    private void initComponents() {
        ...
        addButton.setText("Thêm phiếu nhập");
        ...
        editButton.setText("Sửa phiếu nhập");
        ...
        deleteButton.setText("Xoá phiếu nhập");
    ...
    private void deleteButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteButtonActionPerformed
        ...
        int row = imTable.getSelectedRow();
        if (row == -1) {
            JOptionPane.showMessageDialog(QuanLyPhieuNhap.this, "Vui lòng chọn phiếu nhập!", "Lỗi", JOptionPane.ERROR_MESSAGE);
        } else {
            try {
                imSer.deletePhieuNhap(String.valueOf(imTable.getValueAt(row, 0)));
                JOptionPane.showMessageDialog(QuanLyPhieuNhap.this, "Thành công!", "Thông báo", JOptionPane.INFORMATION_MESSAGE);
                ims = imSer.getAllPhieuNhap();
                dfTableModel.setRowCount(0);
                if (ims != null) 
                    setTableData(ims);
            } catch (Exception e) {
                JOptionPane.showMessageDialog(QuanLyPhieuNhap.this, "Thất bại!", "Thông báo", JOptionPane.INFORMATION_MESSAGE);
            }
        }
    ...
    private void editButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_editButtonActionPerformed
        ...
        if (row == -1) {
            ...
            String ma = String.valueOf(imTable.getValueAt(row, 0));
            new SuaPhieuNhap(ma).setVisible(true);
            this.dispose();
        }
    ...
    private void detailButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_detailButtonActionPerformed
        ...
        if (row == -1) {
            ...
            String ma = String.valueOf(imTable.getValueAt(row, 0));
            new XemChiTietPhieuNhap(ma).setVisible(true);
            this.dispose();
        }
